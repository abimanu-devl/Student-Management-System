...
<body bgcolor="#FFFFF1">
<%
		Employee u1 = (Employee) request.getAttribute("empdetails");
                ...
                <div class="card-body">
                   <form method="POST" action="empUpdate">
                        ...
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="desingnation" placeholder="Designation" value="<%=u1.getDesignation()%>">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="otHours" placeholder="OT Hours" value="<%=u1.getOT_hours()%>">
                                </div>
                            </div>
                        </div>
                         <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="otRate" placeholder="OT Rate" value="<%=u1.getOT_Rate()%>">
                                </div>
                            </div>
                        </div>
                         <div class="form-row">
                            ...
                            <div class="value">
                                <div class="input-group">
                                    <input class="input--style-5" type="text" name="phone" placeholder="Mobile" maxlength="10" value="<%=u1.getTelephone()%>">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                        ...
                        <div class="form-row">
                          ...
                          <div class="form-row">
                            <div class="name">Employee Type</div>
                            <div class="value">
                                <div class="input-group">
                                    <div class="rs-select2 js-select-simple select--no-search">
                                        <select name="type">
                                            <option value="<%=u1.getEmployeeType()%>" selected><%=u1.getEmployeeType()%></option>
                        ...
                        <div><center>
                            <button class="btn btn--radius-2 btn--blue" type="submit" name="empID" value="<%=u1.getEmployeeID()%>">Save</button>
                        </center></div>
                    </form>
                </div>
            </div>
