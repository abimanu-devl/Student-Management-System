 ...
 */
@WebServlet("/CSVReportSubject")
public class CSVReportSubject extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public CSVReportSubject() {
		super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (SelectedSubject.equals("AllSub")) {
			...
			arrayList = HallsDao.selectAllHallsSub(SelectedSubject);
		}
